...
\mwguia{Guía 2 — Aritmética, Álgebra y Ecuaciones}{Gabriel Astudillo $\cdot$ Curso 3er Año}
...
\begin{itemize}[leftmargin=*]
  ...
  \item Si $n > 0$: el número original es \textbf{grande}.
  \item Si $n < 0$: el número original es \textbf{pequeño}.
\end{itemize}
\end{cuadrosolucion}
...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[x=1cm, y=1cm]
    ...
    \node[text=mwprimario, font=\bfseries] at (-3,-1.15) {$3x + 2$};
    ...
    \node[text=mwprimario, font=\bfseries] at (3,-1.15) {$14$};
    
    % Equal sign in the middle
    \node[text=mwmagenta, font=\Huge\bfseries] at (0,-1.3) {$=$};
  \end{tikzpicture}
