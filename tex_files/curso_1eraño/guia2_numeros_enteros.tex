...
\mwguia{Guía 2 — Números Enteros y sus Operaciones}{Gabriel Astudillo $\cdot$ Curso 1er Año}
...
\begin{cuadrosolucion}
  \textbf{Para sumar:}
  \begin{itemize}
    \item \textbf{Igual signo:} suma los valores absolutos y conserva el signo.
          \quad $-4 + (-3) = -7$ \quad y \quad $5 + 8 = 13$.
    \item \textbf{Signos diferentes:} resta el menor valor absoluto del mayor y ponle el signo del que tiene mayor valor absoluto.
