...
\mwguia{Guía 4 — Ecuaciones de Primer Grado en $\Z$}{Gabriel Astudillo $\cdot$ Curso 1er Año}
...
\begin{cuadroinfo}
  \small
  \textbf{Presentación:} Imagina una \textbf{balanza} en equilibrio: si agregas una piedra a un lado y no al otro, se desbalancea. Para mantenerla equilibrada, todo lo que hagas en un lado \emph{debes} hacerlo en el otro. Así funcionan las \textbf{ecuaciones}: son misterios donde una letra (la \textbf{incógnita}) esconde un número, y tú eres el detective que debe descubrirlo. En esta guía aprenderás a escribir problemas en «idioma matemático» y a resolver ecuaciones paso a paso, comprobando siempre tu respuesta.
  \\[4pt]
...
\begin{enumerate}[leftmargin=*]
  ...
  \item \dificil{} \textbf{El reto de los campeones:} Traduce a una ecuación con una sola incógnita: «Un padre tiene el triple de la edad de su hijo. Si la suma de sus edades más $5$ años es igual a $53$ años, \textquestiondown cuál es la ecuación que permite hallar la edad del hijo $h$?».
\end{enumerate}
...
\begin{cuadrosolucion}
  ...
  \begin{enumerate}
    \item Lee el problema con calma.
    \item Elige la incógnita (¿qué me preguntan?).
...
\begin{enumerate}[leftmargin=*]
  ...
  \item \dificil{} \textbf{El reto de los campeones 1 (Adivina el número):} «Pensé un número entero, lo multipliqué por $-3$, al resultado le sumé $18$, luego multipliqué todo por $2$ y finalmente le resté $10$, obteniendo $32$». \textquestiondown Cuál fue el número que pensé? (Escribe la ecuación completa con paréntesis y corchetes, resuélvela paso a paso y comprueba).

  \item \dificil{} \textbf{El reto de los campeones 2 (Desafío de edades cruzadas):} Un padre tiene $45$ años y sus dos hijos tienen $8$ y $12$ años. \textquestiondown Dentro de cuántos años la edad del padre será igual a la suma de las edades de sus dos hijos?
\end{enumerate}
