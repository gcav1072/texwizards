...
\begin{enumerate}[leftmargin=*, resume]
  ...
  \item \dificil{} \textbf{:} ¿Qué ángulo forman las manecillas del reloj a las 7:20? (Pista: la manecilla de las horas no apunta exactamente a las 7: a las 7:20 ha avanzado $\frac{20}{60} \cdot 30^{\circ} = 10^{\circ}$ más allá de las 7.)
\end{enumerate}
