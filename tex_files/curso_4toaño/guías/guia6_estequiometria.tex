...
\mwguia{Guía 6 — Estequiometría}{Gabriel Astudillo $\cdot$ 4to Año}
...
\begin{cuadropasos}
  \textbf{Conversiones con el mol:}
  \begin{center}
    \begin{tabular}{lccc}
      \toprule
      De         & a          & Operación             & Factor               \\
      \midrule
      gramos     & moles      & dividir entre $M$     & $n = \dfrac{m}{M}$   \\
      moles      & gramos     & multiplicar por $M$   & $m = n \cdot M$      \\
      moles      & partículas & multiplicar por $N_A$ & $N = n \cdot N_A$    \\
      partículas & moles      & dividir entre $N_A$   & $n = \dfrac{N}{N_A}$ \\
      \bottomrule
    \end{tabular}
  \end{center}
\end{cuadropasos}
...
\begin{cuadroadvertencia}
  ...
  \begin{itemize}[leftmargin=*]
    ...
    \item Dividir cuando hay que multiplicar: de gramos a moles se \emph{divide}; de moles a gramos se \emph{multiplica}.
  \end{itemize}
...
\begin{cuadrosolucion}
  \textbf{Solución:}
  $$n = \frac{m}{M} = \frac{46 \text{ g}}{23 \text{ g/mol}} = 2 \text{ mol de Na}.$$
\end{cuadrosolucion}
...
\begin{cuadrosolucion}
  \textbf{Solución:}
  $$m = n \cdot M = 3 \text{ mol} \cdot 18 \frac{\text{g}}{\text{mol}} = 54 \text{ g de H}_2\text{O}.$$
\end{cuadrosolucion}
...
\begin{cuadrosolucion}
  \textbf{Solución:}
  $$N = n \cdot N_A = 2 \text{ mol} \cdot 6{,}022 \times 10^{23} = 1{,}2044 \times 10^{24} \text{ moléculas de CO}_2.$$
\end{cuadrosolucion}
