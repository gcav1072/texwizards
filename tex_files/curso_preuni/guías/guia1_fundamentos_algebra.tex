...
% ── Portada / Título ─────────────────────────────────────────
\mwportada{Guía de Estudio 1}{Fundamentos de Álgebra}{Exponentes, Factorización, Racionalización, Fracciones Algebraicas, Ecuaciones y Desigualdades}

\vspace{4pt}
\begin{cuadroinfo}
      \small
      \textbf{Presentación:} Esta primera guía sienta las bases operativas y conceptuales de todo el curso preuniversitario y de cálculo diferencial. Dominar las leyes de los exponentes, todos los casos de factorización, la racionalización de diversos órdenes, el álgebra de fracciones complejas, la resolución de ecuaciones y el trabajo con desigualdades es indispensable para abordar con éxito los temas de funciones, límites y derivadas. Cada sección incluye un marco teórico exhaustivo, ejercicios resueltos paso a paso y ejercicios propuestos con su clave de respuestas.
      \\[4pt]
...
\subsection{Ejercicios resueltos: Exponentes y Radicales}
...
\subsection{Ejercicios propuestos: Exponentes y Radicales}
...
\textbf{Ejemplo R2 (Factor Común y Agrupación).} Factoriza: $a)\; 6x^3 y^2 - 9x^2 y^4 + 15x^4 y^3 \qquad b)\; x^3 - 3x^2 - 4x + 12$.
...
\textbf{Ejemplo R3 (Trinomio $ax^2 + bx + c$).} Factoriza: $6x^2 - 11x - 10$.
...
\textbf{Ejemplo R4 (Suma y Diferencia de Cubos).} Factoriza: $a)\; 27x^3 + 64 \qquad b)\; 8x^6 - y^3$.
...
\textbf{Ejemplo R5 (Completación de Cuadrados / Sophie Germain).} Factoriza: $x^4 + 4y^4$.
...
\textbf{Ejemplo R6 (Combinación Múltiple).} Factoriza completamente: $x^6 - 64$.
...
\section{Técnicas de Racionalización}
% ============================================================
...
\subsection{Ejercicios resueltos: Racionalización}

\textbf{Ejemplo R7.} Racionaliza el denominador monomio con raíz cúbica: $\dfrac{5}{\sqrt[3]{2x}}$.
...
\textbf{Ejemplo R8.} Racionaliza el denominador binomio: $\dfrac{6}{\sqrt{7} - 2}$.
...
\textbf{Ejemplo R9.} Racionaliza el denominador que contiene una raíz cúbica en binomio: $\dfrac{4}{\sqrt[3]{x} + 2}$.
...
\textbf{Ejemplo R10.} Racionaliza el numerador de $\dfrac{\sqrt{x + 9} - 3}{x}$ y simplifica para $x \neq 0$.
...
\subsection{Ejercicios propuestos: Racionalización}
...
\subsection*{Sección 1: Exponentes y Radicales (Ejercicios 1--2)}
...
\subsection*{Sección 2: Factorización (Ejercicios 3--10)}
...
\subsection*{Sección 3: Racionalización (Ejercicios 11--16)}
\begin{enumerate}[resume=respuestas, leftmargin=*, label=\textbf{\arabic*.}]
...
\subsection*{Sección 4: Fracciones Algebraicas (Ejercicios 17--21)}
\begin{enumerate}[resume=respuestas, leftmargin=*, label=\textbf{\arabic*.}]
...
\subsection*{Sección 5: Ecuaciones (Ejercicios 22--28)}
\begin{enumerate}[resume=respuestas, leftmargin=*, label=\textbf{\arabic*.}]
...
\subsection*{Sección 6: Desigualdades (Ejercicios 29--35)}
\begin{enumerate}[resume=respuestas, leftmargin=*, label=\textbf{\arabic*.}]
...
% ──────────────────────────────────────────────────────────
\subsection*{Sección 7: Repaso Integral de Álgebra I (Ejercicios 36--43)}
\begin{enumerate}[resume=respuestas, leftmargin=*, label=\textbf{\arabic*.}]
...
\subsection*{Sección 8: Repaso Integral de Álgebra II (Ejercicios 44--50)}
\begin{enumerate}[resume=respuestas, leftmargin=*, label=\textbf{\arabic*.}]
      \item $2a^7 b^6$
