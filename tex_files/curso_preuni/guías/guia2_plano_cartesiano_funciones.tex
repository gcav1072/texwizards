...
\mwguia{Guía 2 — Plano Cartesiano, Relaciones y Gráficas Básicas}{Ing. Gabriel Astudillo $\cdot$ Curso Preuniversitario}
...
\begin{enumerate}[leftmargin=*, label=\textbf{\arabic*.}]
  ...
  \item Simplificando: $f(x) = \dfrac{1}{x - 1}$ (con $x \neq -1$). Dominio: $\mathbb{R} \setminus \{\pm 1\}$; \quad rango: $\mathbb{R} \setminus \{0\}$.
