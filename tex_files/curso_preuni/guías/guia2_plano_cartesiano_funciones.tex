...
\mwguia{Guía 2 — Int. a Funciones}{Gabriel Astudillo}

\begin{document}
% ============================================================

% ── Portada / Título ─────────────────────────────────────────
\mwportada{Guía de Estudio 2}{Plano Cartesiano, Funciones y Transformaciones}{Distancia, Punto Medio, Dominio, Rango y Transformaciones de Gráficas}

\vspace{4pt}
\begin{cuadroinfo}
  \small
  \textbf{Presentación:} Las funciones son el lenguaje universal del cálculo. En esta guía aprenderás a localizar puntos en el plano cartesiano, a distinguir funciones de simples relaciones, a calcular dominios y rangos, a graficar las funciones básicas y a transformar esas gráficas mediante traslaciones, reflexiones y estiramientos. Cada sección incluye \textbf{ejercicios resueltos} y \textbf{ejercicios propuestos}.
  \\[4pt]
...
\begin{enumerate}[leftmargin=*, label=\textbf{\arabic*.}]
  \setcounter{enumi}{8}
  \item a) Función. b) No es función (xiembre: $x=2$ con dos $y$). c) Función (recta). d) No es función (para un $x$ hay dos $y$; falla la recta vertical).
...
\subsection*{Sección 4: Transformaciones (Ejercicios 33--44)}
