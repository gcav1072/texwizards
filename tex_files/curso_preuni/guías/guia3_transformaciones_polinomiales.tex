...
\mwguia{Guía 3 — Transformaciones y Funciones Polinomiales}{Ing. Gabriel Astudillo $\cdot$ Curso Preuniversitario}
...
% ──────────────────────────────────────────────────────────
\subsection*{Sección 4: Transformaciones Combinadas (Ejercicios 25--33)}
\begin{enumerate}[leftmargin=*, label=\textbf{\arabic*.}]
  \setcounter{enumi}{24}
...
\subsection*{Sección 5: Polinomiales — Raíces y División Sintética (Ejercicios 34--42)}
\begin{enumerate}[leftmargin=*, label=\textbf{\arabic*.}]
  \setcounter{enumi}{33}
