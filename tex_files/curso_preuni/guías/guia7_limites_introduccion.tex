...
\mwguia{Guía 7 — Introducción al Límite y Límites Algebraicos}{Ing. Gabriel Astudillo $\cdot$ Curso Preuniversitario}
...
% ──────────────────────────────────────────────────────────
\subsection*{Sección 4: Límites Intuitivos y Laterales (Ejercicios 25--33)}
\begin{enumerate}[leftmargin=*, label=\textbf{\arabic*.}]
  \setcounter{enumi}{24}
  \item $11$
...
\subsection*{Sección 5: Límites Algebraicos Avanzados (Ejercicios 34--42)}
\begin{enumerate}[leftmargin=*, label=\textbf{\arabic*.}]
  \setcounter{enumi}{33}
