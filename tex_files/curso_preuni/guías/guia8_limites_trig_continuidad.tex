...
\mwguia{Guía 8 — Límites Trigonométricos, al Infinito y Continuidad}{Ing. Gabriel Astudillo $\cdot$ Curso Preuniversitario}
...
% ──────────────────────────────────────────────────────────
\subsection*{Sección 4: Límites Trigonométricos (Ejercicios 25--33)}
\begin{enumerate}[leftmargin=*, label=\textbf{\arabic*.}]
  \setcounter{enumi}{24}
  \item $3$
  \item $\dfrac{1}{2}$
...
\subsection*{Sección 5: Límites al Infinito y Continuidad (Ejercicios 34--42)}
\begin{enumerate}[leftmargin=*, label=\textbf{\arabic*.}]
  \setcounter{enumi}{33}
  \item $0$
  \item $5$
