...
\begin{frame}{Ejercicio 2}
  \begin{mwejercicio}[Ejercicio 2 — Racionalización Directa \quad \facil]
...
\begin{frame}{Ejercicio 3}
  \begin{mwejercicio}[Ejercicio 3 — Factor Común y Diferencia de Cuadrados \quad \facil]
...
\begin{frame}{Ejercicio 4}
  \begin{mwejercicio}[Ejercicio 4 — Trinomios Cuadráticos \quad \medio]
...
\begin{frame}{Ejercicio 5}
  \begin{mwejercicio}[Ejercicio 5 — Suma/Diferencia de Cubos y Agrupación \quad \medio]
...
\begin{frame}{Ejercicio 6}
  \begin{mwejercicio}[Ejercicio 6 — Racionalización de Binomios Cúbicos \quad \medio]
...
\begin{frame}{Ejercicio 7}
  \begin{mwejercicio}[Ejercicio 7 — Suma y Resta de Fracciones Algebraicas \quad \medio]
...
\begin{frame}{Ejercicio 8}
  \begin{mwejercicio}[Ejercicio 8 — Fracciones Complejas \quad \dificil]
...
\begin{frame}{Ejercicio 9}
  \begin{mwejercicio}[Ejercicio 9 — Completación de Cuadrados (Sophie Germain) \quad \dificil]
